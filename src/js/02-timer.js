...
const myInput = document.querySelector("#datetime-picker")._flatpickr;
const startBtn = document.querySelector('button[data-start]');
const onDays = document.querySelector('span[data-days]');
const onHours = document.querySelector('span[data-hours]');
...
function viewOfTimer({ days, hours, minutes, seconds }) {
  onDays.textContent = `${days}`;
  onHours.textContent = `${hours}`;
